              ...
              return (
                <motion.div
                  ...
                  animate={{
                    ...
                    filter:
                      offset === 0
                        ? "brightness(1.2) drop-shadow(0px 0px 25px rgba(17,24,39,0.65))"
                        : "brightness(0.85) blur(1px)",
                    boxShadow:
                      offset === 0
                        ? "0px 0px 35px rgba(17,24,39,0.6)"
                  ...
                  <Link to={card.link}>
                    <div className="relative group h-full">
                      ...
                      <div className="p-5">
                        ...
                        <span className="text-primary font-semibold text-sm mt-3 inline-block">
                          {tExplore} →
                        </span>
                      </div>
                    </div>
